...
public class CharacterMotor : MonoBehaviour {
    ...
    public class CharacterMotorMovement {
	    ...
	    // For the next variables, [System.NonSerialized] public  tells Unity to not serialize the variable or show it in the inspector view.
    ...
    void UpdateFunction (){
	    ...
	    if (MoveWithPlatform()) {
            ...
            if (yRotation != 0) {
	            ...
	            Trnsfrm.Rotate(0, yRotation, 0);
            }
	    }
	
	    // Save lastPosition for velocity calculation.
	    Vector3 lastPosition = Trnsfrm.position;
	    ...
	    movement.velocity = (Trnsfrm.position - lastPosition) / Time.deltaTime;
	    ...
	    if (grounded && !IsGroundedTest()) {
		    ...
		    Trnsfrm.position += pushDownOffset * Vector3.up;
	    }
	    ...
	    if (MoveWithPlatform()) {
		    ...
		    movingPlatform.activeGlobalPoint = Trnsfrm.position + Vector3.up * (controller.center.y - controller.height*0.5f + controller.radius);
		    movingPlatform.activeLocalPoint = movingPlatform.activePlatform.InverseTransformPoint(movingPlatform.activeGlobalPoint);
		
		    // Support moving platform rotation as well:
            movingPlatform.activeGlobalRotation = Trnsfrm.rotation;
    ...
    Vector3 GetDesiredHorizontalVelocity (){
	    // Find desired velocity
	    Vector3 desiredLocalDirection = Trnsfrm.InverseTransformDirection(inputMoveDirection);
	    ...
	    return Trnsfrm.TransformDirection(desiredLocalDirection * maxSpeed);
    }
